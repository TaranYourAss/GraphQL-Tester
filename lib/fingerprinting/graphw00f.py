#!/usr/bin/env python
# This file is based on code from the graphw00f project by dolevf.
# Original License: BSD 3-Clause
# Original Sources:
#  - Project: https://github.com/dolevf/graphw00f
#  - File: https://github.com/dolevf/graphw00f/blob/main/graphw00f/lib.py
# Copyright (c) 2021, graphw00f
# All rights reserved.
#
# graphw00f LICENSE: https://github.com/dolevf/graphw00f/blob/main/LICENSE
#
# Modifications Copyright (c) 2024: taranyourass
